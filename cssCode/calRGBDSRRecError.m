function [ SRRecError, propSRRecError, diffpropSRRecError ] = calRGBDSRRecError( CFD,feat,P )
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
...
diffpropSRRecError = norm_minmax(P*propSRRecError');% spnum*1 Manifold Ranking-based Diffusion
end
