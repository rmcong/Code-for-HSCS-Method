...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
function [ sup_info, adjc, inds] = get_sup_info( superpixels, input_vals, depth, sin_sal, ScaleH, ScaleW )
...
inds = cell(spnum,1);
[x, y] = meshgrid(1:1:ScaleW, 1:1:ScaleH);%ScaleH×ScaleW的矩阵，每行是1~n的数字
